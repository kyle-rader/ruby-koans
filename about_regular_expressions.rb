...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_a_regexp_can_search_a_string_for_matching_content
    ...
    assert_equal 'match', content[/match/]
    assert_equal 'matching content', content[/mat.*$/] # Amazing! So Useful, So Easy!
  end
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    assert_equal 42, "the number is 42"[/[0123456789]+/].to_i
    assert_equal 42, "the number is 42"[/\d+/].to_i
  end
