...
class AboutIteration < Neo::Koan
  ...
  def test_each_is_a_method_on_arrays
    assert_true [].methods.include?(as_name(:each))
  end
  ...
  def test_collect_transforms_elements_of_an_array
    ...
    another_array = array.map { |item| item + 20 }
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    odd_numbers = array.find_all { |item| (item % 2) == 1 }
    assert_equal [1, 3, 5], odd_numbers
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Same as reduce, oddly also could be named collect...
  end
